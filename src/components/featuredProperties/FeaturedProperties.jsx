    ...
    <div className="fp">
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        />
        <span className="fpName">Well styles</span>
      ...
      <div className="fpItem">
        ...
        <span className="fpCity">Porvorim</span>
        <span className="fpPrice">Starting from Rs 1999</span>
        <div className="fpRating">
          <button>8.8</button>
          <span>Excellent</span>
        </div>
      ...
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        />
        <span className="fpName">Vista De Rio</span>
        <span className="fpCity">Goa</span>
